...
const walkFrames = importAll(import.meta.glob("@/assets/sprites/Creep_Range/Walk/*"));
const deathFrames = importAll(import.meta.glob("@/assets/sprites/Creep_Range/Death/*"));
